...
<head>
	...
	<!-- google font -->
	<link
		href="{{ url('main/https://fonts.googleapis.com/css?family=Open+Sans:300,400,700" rel="stylesheet') }}">
	<link
		href="{{ url('main/https://fonts.googleapis.com/css?family=Poppins:400,700&display=swap" rel="stylesheet') }}">
	<!-- fontawesome -->
...
<body>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Why <span class="orange-text">Shoes</span></h2>
						<div class="row">
							<div class="col-lg-6 col-md-6 mb-md-5 mb-4">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Home Delivery</h3>
										<p>sit voluptatem accusantium dolore mque laudantium, totam rem
											aperiam, eaque ipsa quae ab illo.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 mb-md-5 mb-5">
								<div class="list-box d-flex">
									<div class="list-icon">
	...
	<!-- testimonail-section -->
	{{-- <div class="testimonail-section mb-150 mt-80">
		<div class="container">
			<div class="row">
