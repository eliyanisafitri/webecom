...
<body>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<div class="site-logo">
							<a href="index.html">
								<img src="{{ url('main/assets/img/logo.png') }}" alt="">
							</a>
						</div>
						<!-- logo -->
	...
	<div class="list-section pb-80 pt-80">
		<div class="container">
			...
			<div class="row">
					...
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img
									src="{{ url('main/assets/img/products/product-img-1.jpg') }}"
									alt=""></a>
						</div>
						<h3>Strawberry</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img
									src="{{ url('main/assets/img/products/product-img-2.jpg') }}"
									alt=""></a>
						</div>
						<h3>Berry</h3>
				...
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img
									src="{{ url('main/assets/img/products/product-img-3.jpg') }}"
									alt=""></a>
						</div>
						<h3>Lemon</h3>
			...
			<div class="row clearfix">
				...
				<div class="image-column col-lg-6">
					<div class="image">
						...
						<img src="{{ url('main/assets/img/a.jpg') }}" alt="">
					</div>
				</div>
				<!--Content Column-->
				<div class="content-column col-lg-6">
					...
					<div class="text">Quisquam minus maiores repudiandae nobis, minima saepe
						id, fugit ullam similique! Beatae, minima quisquam molestias facere ea.
						Perspiciatis unde omnis iste natus error sit voluptatem accusant</div>
					<!--Countdown Timer-->
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="{{ url('main/assets/img/avaters/avatar1.png') }}"
									alt="">
							</div>
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="{{ url('main/assets/img/avaters/avatar2.png') }}"
									alt="">
							</div>
							<div class="client-meta">
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="{{ url('main/assets/img/avaters/avatar3.png') }}"
									alt="">
							</div>
							<div class="client-meta">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<p>Etiam vulputate ut augue vel sodales. In sollicitudin neque et massa
							porttitor vestibulum ac vel nisi. Vestibulum placerat eget dolor sit amet
							posuere. In ut dolor aliquet, aliquet sapien sed, interdum velit. Nam eu
							molestie lorem.</p>
	...
	<section class="shop-banner">
		<div class="container">
			<h3>December sale is on! <br> with big <span
					class="orange-text">Discount...</span></h3>
			<div class="sale-percent"><span>Sale! <br> Upto</span>50% <span>off</span>
			</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<div class="news-text-box">
							<h3><a href="single-news.html">You will vainly look for fruit on it in
									autumn.</a></h3>
							<p class="blog-meta">
							...
							<p class="excerpt">Vivamus lacus enim, pulvinar vel nulla sed,
								scelerisque rhoncus nisi. Praesent vitae mattis nunc, egestas viverra
								eros.</p>
				...
				<div class="col-lg-12">
					<div class="logo-carousel-inner">
						<div class="single-logo-item">
							<img src="{{ url('main/assets/img/company-logos/1.png') }}"
								alt="">
						</div>
						<div class="single-logo-item">
							<img src="{{ url('main/assets/img/company-logos/2.png') }}"
								alt="">
						</div>
						<div class="single-logo-item">
							<img src="{{ url('main/assets/img/company-logos/3.png') }}"
								alt="">
						</div>
						<div class="single-logo-item">
							<img src="{{ url('main/assets/img/company-logos/4.png') }}"
								alt="">
						</div>
						<div class="single-logo-item">
							<img src="{{ url('main/assets/img/company-logos/5.png') }}"
								alt="">
						</div>
					</div>
				</div>
